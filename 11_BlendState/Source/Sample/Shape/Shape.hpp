...
public:
    ...
    // 板ポリゴンとして初期化
    void InitializeAsPlane(f32 scaleX, f32 scaleY, const glm::vec4* pColor = nullptr);
...
protected:
    ...
    D3D_PRIMITIVE_TOPOLOGY              m_PrimitiveTopology;    // プリミティブトポロジー
